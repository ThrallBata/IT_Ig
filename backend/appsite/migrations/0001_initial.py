    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='staff', to=settings.AUTH_USER_MODEL, verbose_name='Работник')),
            ],
        ),
        migrations.CreateModel(
            name='OrderStatus',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='appsite.orderstatus', verbose_name='Статус')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
