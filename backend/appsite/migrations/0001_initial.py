# Generated by Django 4.1.7 on 2023-05-05 02:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='staff', to=settings.AUTH_USER_MODEL, verbose_name='Работник')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Клиент')),
                ('project_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='appsite.project', verbose_name='Проект')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
            fields=[
                ...
                ('chat', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='appsite.chat', verbose_name='Чат')),
